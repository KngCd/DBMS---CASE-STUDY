          ...
          <div id="mySidenav" class="sidenav">
            ...
            <?php 
                ...
                <?php 
                  ...
                  ac.due_date, ac.time, ac.filetype, ac.uploaded, ac.classcode, ac.teacher_id
                  FROM class_student cs
                  JOIN class c ON cs.classcode = c.classcode
                  JOIN activity ac ON c.classcode = ac.classcode
                  LEFT JOIN activitylog al ON ac.act_id = al.activity_id
                  WHERE cs.student_id = '$id' AND al.activity_id IS NULL");
                  $result = mysqli_num_rows($query);
