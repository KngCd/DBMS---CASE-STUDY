...
<div class="main">
    <div class="table" id="main">
      <?php
        ...
        ac.topic, ac.points, ac.classcode, ac.teacher_id, al.student_id, al.file, al.filetype, al.comment, al.uploaded
        ...
        while ($row = mysqli_fetch_assoc($query)) {
            ...
            $activitylog_query = mysqli_query($con, "SELECT * FROM activitylog WHERE student_id = $row[student_id] AND activity_id = $act_id");
